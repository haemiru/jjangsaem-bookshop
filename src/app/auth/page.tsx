      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-bg-primary p-6 shadow-sm">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-border py-3 text-sm font-medium text-text-primary transition-colors hover:bg-bg-secondary"
          >
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full rounded-lg border border-border bg-bg-primary px-4 py-2.5 text-sm text-text-primary outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary"
